...
Console.WriteLine("Request1" + DBConfiguration.GetDBConfiguration().ConnectionString);
Console.WriteLine("Request2" + DBConfiguration.GetDBConfiguration().ConnectionString);
Console.WriteLine("Request3" + DBConfiguration.GetDBConfiguration().ConnectionString);