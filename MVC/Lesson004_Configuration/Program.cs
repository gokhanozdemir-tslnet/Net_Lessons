...
//Options pattern
MasterKey masterKeys = new MasterKey();
builder.Configuration.GetSection(nameof(MasterKey)).Bind(masterKeys);

//Configuration as a Service
builder.Services.Configure<MasterKey>(builder.Configuration.GetSection(nameof(MasterKey)));
